...
if(IE)
{Wilq32.PhotoEffect.prototype.createVMLNode=(function(){document.createStyleSheet().addRule(".rvml","behavior:url(#default#VML)");try{!document.namespaces.rvml&&document.namespaces.add("rvml","urn:schemas-microsoft-com:vml");return function(tagName){return document.createElement('<rvml:'+tagName+' class="rvml">')}}catch(e){return function(tagName){return document.createElement('<'+tagName+' xmlns="urn:schemas-microsoft.com:vml" class="rvml">')}}})()}})(jQuery);resources/Bootstrap/js/bootstrap.min.js;resources/Bootstrap/js/ie10-viewport-bug-workaround.js;var AdminWebPageFormResult={id:"#informationContainer",css:["alert-success","alert-danger","alert-info"],setup:function(){$(AdminWebPageFormResult.id).find(".close").click(function(){AdminWebPageFormResult.hide()})},show:function(){$(AdminWebPageFormResult.id).show(400);return this},hide:function(){$(AdminWebPageFormResult.id).hide(400);return this},setSuccess:function(success){var c=(success)?AdminWebPageFormResult.css[0]:AdminWebPageFormResult.css[1];$(AdminWebPageFormResult.id).find(".alert").removeClass(AdminWebPageFormResult.css.join(" ")).addClass(c).find(".message").html((success)?"":"<strong>Se encontraron errores!</strong>");return this},addMessage:function(message){$(AdminWebPageFormResult.id).find(".message").append(message);return this},setProcessing:function(){$(AdminWebPageFormResult.id).find(".alert").removeClass(AdminWebPageFormResult.css.join(" ")).addClass(AdminWebPageFormResult.css[2]).find(".message").html("<strong><span class='fa fa-spinner fa-spin'></span> Procesando...</strong>");return this}};$(document).ready(AdminWebPageFormResult.setup);resources/Ima/js/FormField.js;$(".simpleFormSelectFieldSubmitOnChange").change(function(){$(this).closest("form").submit()});$(function($){var RegresarButton=function(element){this.$element=$(element);this.$spinner=this.$element.find(".regresarSpinner");this.$arrow=this.$element.find(".regresarArrow");this.setup()};RegresarButton.prototype={setup:function(){this.$element.on("click",$.proxy(this.handleButtonClick,this))},handleButtonClick:function(e){e.preventDefault();this.$spinner.show();this.$arrow.hide();this.$element.prop("disabled",!0);window.location=this.$element.attr("previous-url")}};$.fn.regresarButton=function(){return this.each(function(){var $this=$(this),data=$this.data('regresarButton');if(!data)
$this.data('regresarButton',(data=new RegresarButton(this)))})};$("button.regresarButton").regresarButton()}(jQuery))